...
SIGNATURE_IMAGE = "assets/contact/selim-sabahoglu-signature.png?v=10"
...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="{p}css/styles.css?v=201" />
    {extra_head}
  </head>
  <body>
            ...
            <div class="guide-kontakt__panel guide-kontakt__panel--profile">
              <div class="guide-kontakt__profile-grid">
                ...
                <div class="guide-kontakt__profile-body">
                  ...
                  <p class="guide-kontakt__signature"><img class="guide-kontakt__signature-img" src="{SIGNATURE_IMAGE}" alt="Unterschrift {OWNER}" width="420" height="134" loading="lazy" decoding="async" /></p>
    ...
    <section class="section content-light">
      <form id="schaden-form" class="panel">
        ...
        <label class="schaden-consent" for="schaden-consent">
          ...
          <span><span class="schaden-consent__required" aria-hidden="true">*</span> I consent to the sharing and processing of the information provided above for the purpose of handling my request. I understand that my data will be securely stored and automatically deleted after 14 days.</span>
        </label>
