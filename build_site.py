...
SIGNATURE_IMAGE = "assets/contact/selim-sabahoglu-signature.png?v=9"
            ...
            <div class="guide-kontakt__panel guide-kontakt__panel--profile">
              <div class="guide-kontakt__profile-grid">
                ...
                <div class="guide-kontakt__profile-body">
                  ...
                  <p class="guide-kontakt__signature"><img class="guide-kontakt__signature-img" src="{SIGNATURE_IMAGE}" alt="Unterschrift {OWNER}" width="420" height="171" loading="lazy" decoding="async" /></p>
