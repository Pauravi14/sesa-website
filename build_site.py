...
PROCESS_FLOW_ARROW_HEAD = (
    '<svg class="process-flow__arrow-head" viewBox="0 0 36 10" preserveAspectRatio="xMidYMid meet" '
    'focusable="false" aria-hidden="true">'
    '<path d="M4 1.5 L32 5 L4 8.5" fill="none" stroke="currentColor" stroke-width="2" '
...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="{p}css/styles.css?v=194" />
    {extra_head}
  </head>
  <body>
