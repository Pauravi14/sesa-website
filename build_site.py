...
def kontakt_page_body() -> str:
    ...
    phone_icon = (
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" '
        'stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<path d="M6.6 10.8a13 13 0 0 0 5.7 5.7l2.1-2.1a1 1 0 0 1 1-.24c1.1.37 2.2.57 3.4.57a1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A16 16 0 0 1 3 4a1 1 0 0 1 1-1h3.4a1 1 0 0 1 1 1c0 1.2.2 2.4.6 3.5a1 1 0 0 1-.24 1Z"/>'
        "</svg>"
    )
    mail_icon = (
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" '
        'stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">'
        '<rect x="3.5" y="5.5" width="17" height="13" rx="1.5"/><path d="m4 7 8 6 8-6"/>'
        "</svg>"
    )
    pin_icon = (
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" '
            ...
            <div class="guide-kontakt__panel guide-kontakt__panel--profile">
              <div class="guide-kontakt__profile-grid">
                ...
                <div class="guide-kontakt__profile-body">
                  ...
                  <p class="guide-kontakt__signature"><img class="guide-kontakt__signature-img" src="{SIGNATURE_IMAGE}" alt="Unterschrift {OWNER}" width="420" height="142" loading="lazy" decoding="async" /></p>
    ...
    <section class="section content-light">
      <form id="schaden-form" class="panel">
        ...
        <label class="schaden-consent" for="schaden-consent">
          <input id="schaden-consent" name="schaden-consent" type="checkbox" value="yes" aria-describedby="schaden-consent-error" aria-required="true" />
          <span><span class="schaden-consent__required" aria-hidden="true">*</span> Ich willige ein, dass die oben angegebenen Informationen zum Zweck der Bearbeitung meiner Anfrage weitergegeben und verarbeitet werden. Mir ist bekannt, dass meine Daten sicher gespeichert und nach 14 Tagen automatisch gelöscht werden.</span>
        </label>
        <p class="schaden-consent-error" id="schaden-consent-error" role="alert" hidden>Bitte bestätigen Sie die Einwilligung, um fortzufahren.</p>
        <button class="btn btn-solid" type="submit" id="schaden-submit" disabled>Weiter zu WhatsApp</button>
